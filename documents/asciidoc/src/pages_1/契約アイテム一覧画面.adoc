...
| id | id | contract_items | I |
| 名前 | name | contract_items | I |
| 電圧種別名 | voltage_type.name | contract_items | I |
|======================================
...
| 電圧種別名 | voltage_type.name | contract_items | O |
|======================================
...
契約アイテムの一覧API(index)を呼び出して結果を画面にマップする。
