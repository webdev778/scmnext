...
class Pl::BaseDatum < ApplicationRecord
  ...
  class << self
    ...
    def generate_each_bg_member_data(date, bg_member, power_usage_class)
      ...
      # ポジションデータを取得
      plan_matrix_by_time_index_and_resouce_type = Occto::Plan.balanging_group_matrix_by_time_index_and_resouce_type(bg_id: bg_member.baranging_group_id, date: date)
      # ポジション未登録の場合もスキップ
